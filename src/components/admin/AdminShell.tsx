 ...
 return <div className="admin-shell">
  ...
  <aside className={`sidebar ${open?"sidebar-open":""}`}>
   ...
   <div className="system-card"><span className="system-dot"/><div><strong>Catalog online</strong><small>All systems operational</small></div></div>
    <div className="admin-profile"><div className="avatar">AV</div><div><strong>Aria V.</strong><small>Chief Curator</small></div><Link to="/login" className="icon-button" aria-label="Sign out"><LogOut/></Link></div>
  </aside>
